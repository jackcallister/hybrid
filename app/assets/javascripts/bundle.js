...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2),
	    App = __webpack_require__(149);

	document.addEventListener('DOMContentLoaded', function() {
	  var appElement = document.getElementById('app');
	  var payload = JSON.parse(appElement.getAttribute('data-payload'));

	  React.render(React.createElement(App, {payload: payload}), appElement);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewsItem = React.createClass({displayName: "NewsItem",
	  ...
	  render: function() {
	    return (
	      React.createElement("li", null, React.createElement("a", {href: this.props.url}, this.props.title))
	    )
	  }
	})
	...
	var App = React.createClass({displayName: "App",
	  ...
	  renderNewsItems: function() {
	    ...
	    return newsItems.map(function(item) {
	      return React.createElement(NewsItem, {url: item.url, title: item.title})
	    })
	  },
